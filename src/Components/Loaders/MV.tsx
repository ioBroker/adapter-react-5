        ...
        >
            <div style={{ width: 200, height: 200 }}>
                <svg viewBox="0 0 500 500" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%">
                    <circle strokeWidth="5" fill="none" stroke="#01BBF5" cx="250" cy="250" r="200"/>
                    <circle strokeWidth="5" fill="none" stroke="#01BBF5" cx="250" cy="250" r="133"/>
                    <circle strokeWidth="5" fill="none" stroke="#01BBF5" cx="250" cy="250" r="83"/>
                    <circle strokeWidth="5" fill="none" stroke="#01BBF5" cx="250" cy="250" r="66"/>
                    <circle strokeWidth="15" fill="none" stroke="#01BBF5" cx="250" cy="250" r="15"/>
                    <g>
                        ...
                        {Array(24).map((_, i) => <line transform={`rotate(${i * 15}, 250, 250)`} y2="250" x2="115"
                    ...
                    <path
                        ...
                        stroke="none" fill={props.themeType === 'dark' ? '#AAA' : '#222'} fillRule="evenodd"/>
                </svg>
            </div>
        </div>
    </div>;
